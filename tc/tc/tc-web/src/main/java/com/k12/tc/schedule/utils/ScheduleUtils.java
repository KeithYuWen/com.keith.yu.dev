package com.k12.tc.schedule.utils;

import com.k12.tc.schedule.domain.ScheduleJob;
import com.k12.tc.schedule.quartz.JobSyncFactory;
...
import com.k12.tc.common.exceptions.ScheduleException;
import com.k12.tc.schedule.quartz.JobFactory;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, String jobName, String jobGroup,
        ...
        //同步或异步
        Class<? extends Job> jobClass = "1".equals(isSync)? JobSyncFactory.class : JobFactory.class;
     ...
     * @param scheduleJob
     */
    public static void runOnce(Scheduler scheduler, ScheduleJob scheduleJob) {
