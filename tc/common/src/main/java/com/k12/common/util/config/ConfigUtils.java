package com.k12.common.util.config;
...
import com.k12.common.annotation.TableSeg;
import com.k12.common.util.classutil.ClassUtil;
import org.apache.log4j.Logger;

import com.k12.common.util.common.Common;
import com.k12.common.util.ehcache.EhcacheUtils;
...
public class ConfigUtils {
	...
	public void initTableField() {
		...
		try {
			...
			logger.error(" 初始化数据失败,没法加载表字段到缓存 -->> ");
			e.printStackTrace();
		} finally {
			try {
				rs.close();
