...
public class SFTPHandler {  
    ...
    public boolean upload(String directory, String uploadFile) {  
        try {  
           ...
           /*方法一 
            ...
            chSftp.put(uploadFile, directory, new FileProgressMonitor(), ChannelSftp.OVERWRITE); //方法二  
    ...
    public boolean download(String directory, String downloadFile) {  
        try {  
            ...
            chSftp.get(downloadFile, directory, new FileProgressMonitor()); // 代码段1  
