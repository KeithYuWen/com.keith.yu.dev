package com.k12.common.shiro.credentials;

import java.util.concurrent.atomic.AtomicInteger;

import com.k12.common.shiro.vo.RedisCacheManager;
...
public class RetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {
    ...
    public boolean doCredentialsMatch(AuthenticationToken token,
		...
		try {
			retryCount = passwordRetryCache.get("RETRY:"+username);
		} catch (Exception e) {
			e.printStackTrace();
		}
        ...
        if (retryCount == null) {
            ...
            passwordRetryCache.put("RETRY:"+username, retryCount);
        }
