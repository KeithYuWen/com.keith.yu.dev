...
public class TRestUtil {
	...
	public static void writePage(HttpServletResponse response, Object ob) {
		TRestUtil.writeNotCode(response, JsonUtil.toString(ob));
	}
	 ...
	 * 此方法描述的是：分页数据返回
	 */
	public static void writePageWithDateFormat(HttpServletResponse response, Object ob, DateFormat df) {
		TRestUtil.write2(response, JsonUtil.toString(ob, df));
	}
	...
	public static void writeRV(HttpServletResponse response, ResponseVo responseVo) {
		...
		TRestUtil.writeNotCode(response, JsonUtil.toString(responseVo));
	}
	...
	public static void print(HttpServletResponse response, ResponseVo responseVo) {
		TRestUtil.print(response, JsonUtil.toString(responseVo));
	}
	...
	public static ResponseVo executeToVo(String url, String method, String data) {
		try {
			return JsonUtil.toBean(new RestClient(url, method, data).execute(),
					ResponseVo.class);
